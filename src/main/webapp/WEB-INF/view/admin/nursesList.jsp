...
<html lang="pl">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="/helpURL/CSS/admin/nursesList.css">
    <title>Lista pielęgniarek</title>
  </head>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div id="contentTitle">Lista pielęgniarek</div>
                ...
                <div class="content1">
                    ...
                    <table>
                        ...
                        <tr class="dark">
                            ...
                            <th class="text">Id pielęgniarki</th>
                            ...
                            <th class="text">Numer licencji</th>
                            <th class="text"></th>


                        </tr>

                        <c:forEach items="${thomas1}" var="nurse">

                                                <tr>
                                                    <td class="text">1</td>
                                                    <td class="text">${nurse.first_name}</td>

...
<html lang="pl">
  <head>
    <meta charset="utf-8"/>
    <link rel="stylesheet" type="text/css" href="/helpURL/CSS/admin/doctorsList.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div id="contentTitle">Lista lekarzy</div>
                ...
                <div class="content1">
                    ...
                    <c:forEach items="${thomas}" var="doctor">

                        <tr>
                            <td class="text">1</td>
                            <td class="text">${doctor.first_name}</td>

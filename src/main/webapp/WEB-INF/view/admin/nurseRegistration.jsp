...
<html lang="pl">
  <head>
    <meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="/helpURL/CSS/admin/nurseRegistration.css">
    <title>Karta pielęgniarki</title>
  </head>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div id="contentTitle">Dodanie nowej pielęgniarki</div>

                <div class="content1">

                    <form action="/admin/addNurse" method="POST">
                        ...
                        <div id="docCell3">
                            ...
                            <div id="docInput3">
                            <input type="text" name = "date_of_birth" placeholder="DD-MM-RR" required>
                            </div>
                        </div>
